...
// /trace-test — sandbox copy of /agent-inline-trace (forked Aug 11) for
// trying changes without touching the shipped route. Fully independent
// code (its own page/agents/data/css); public assets are shared with
// /agent-inline-trace and /multi-select rather than duplicated.
//
